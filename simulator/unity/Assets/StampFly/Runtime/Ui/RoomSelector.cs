...
namespace StampFly.Ui
{
    ...
    public sealed class RoomSelector : DropdownField, IDisposable
    {
        ...
        public RoomSelector(WorldLoader loader, Action cancelInput, Action restart)
        {
            ...
            string[] priority = { "living_room", "study", "bedroom" };
        ...
        private static string LabelFor(string worldName)
        {
            string readable = worldName.Replace('_', ' ');
            return "Room: " + char.ToUpperInvariant(readable[0]) + readable.Substring(1);
        }
        ...
        private void RefreshCurrent()
        {
            ...
            SetValueWithoutNotify(known ? LabelFor(current) : "Room: Custom layout");
        }
